...
<link rel="stylesheet" href="[[++base_url]]assets/templates/motion/css/style.css" type="text/css" media="screen" />

<script type="text/javascript" src="[[++base_url]]assets/templates/motion/js/accordian.pack.js"></script>
...
<!--Start of each accordion item-->
  ...
  <div id="test-content"><!--DIV which show/hide on click of header-->
    ...
    <div class="accordion_child">
    	<img src="[[++base_url]]assets/templates/motion/images/img_example.jpg" alt="image example" />
