<?php  return array (
  'resourceClass' => 'modStaticResource',
  'resource' => 
  array (
    'id' => 1,
    'type' => 'document',
...
[[!Wayfinder? 
	...
	<div class="message container">
		...
		<p class="col-10 col-sm-9 col-md-7 col-lg-5">Разработка антимонопольного комплаенса, представительство в ФАС России, защита по делам о картелях, консультирование по вопросам антимонопольного законодательства и т.д.</p>
	</div>
</div>
<div style="background-image:url(assets/app/dest/images/slide_bg.png)" class="carousel-item">
	<div class="message container">
		<h1 class="col-12">Второй</h1>
		<p class="col-10 col-sm-9 col-md-7 col-lg-5">ВторойВторойВторой Второй</p>
	</div>
</div>
<div style="background-image:url(assets/app/dest/images/slide_bg.png)" class="carousel-item">
	<div class="message container">
...
<li data-target="#carouselExampleIndicators" data-slide-to="4"></li>
	...
	<div class="content news col-xl-12 col-md-10">
		<hr/>
		<div class="d-flex flex-row justify-content-between flex-wrap w-100 underline">
			<div class="header">Новости и публикации</div>
			<a class="news_all" href="index/novosti-i-publikaczii/">Все новости</a>
		</div>
		<ul class="news_list d-flex flex-row">
...
[[!Wayfinder? 
	...
	<div class="content news col-xl-12 col-md-10">
		...
		<div class="d-flex flex-row justify-content-between flex-wrap w-100 underline">
			<div class="header">Новости и публикации</div>
			<a class="news_all" href="[[~33]]">Все новости</a>
		</div>
		<ul class="news_list d-flex flex-row">
