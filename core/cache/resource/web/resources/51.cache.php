<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p>США сегодня <a href="http://www.forexpf.ru/news/2018/04/06/bm33-rubl-ne-otreagiroval-na-sanktsii-ssha-protiv-olega-deripaski-i-drugikh-biznesmen.html">ужесточили санкции</a> против России, включив в список ряд высокопоставленных должностных лиц, глав крупнейших компаний, в том числе государственных, а также ряд корпораций, в частности, «Рособоронэкспорт». Некоторые последствия этого решения стали очевидны уже сегодня. Так, снижается курс рубля, хотя основная заслуга здесь принадлежит дешевеющей нефти и падению цен на акции в США: инвесторы опасаются замедления темпов мирового экономического роста из-за рисков разрастания торгового противодействия США и Китая.</p>
<p>Акции En+ на новостях о новых санкциях США усилили падение и обрушились на 22%, Русала — на 12%, согласно данным Московской биржи. Компании подконтрольны Олегу Дерипаске. «Базовый Элемент», объединяющий активы Олега Дерипаски, сожалеет о попадании в санкционный список США и изучает сложившуюся в связи с этим ситуацию, говорится в сообщении БазЭла.</p>
<p><img src="assets/app/dest/images/page2.png" alt="" width="652" height="436" /></p>
<p>Число российских юридических лиц, включенные в санкционные списки OFAC, после публикации обновления в пятницу перевалило за 400. До сих пор под санкциями - как в «черном списке», так и под секторальными ограничениями — находилось 388 юрлиц из РФ, следует из данных информационной системы «Интерфакса» X-Compliance. Теперь таких юрлиц 401. Также в пятницу в SDN List было добавлено 24 физлица - всего под санкциями теперь находится 179 граждан РФ.</p>
<p>[[$Quote_inPage]]</p>
<p>Однако Уильям Джексон (William Jackson), старший экономист по развивающимся рынкам в Capital Economics, считает, что новые санкции не затронут инвестиционный имидж России, поскольку основные негативные последствия от санкций страна пережила еще в 2014 году.</p>
<p> </p>
<p> </p>',
    'richtext' => 1,
    'template' => 7,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1523184941,
    'editedby' => 1,
    'editedon' => 1523195139,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1523184960,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'title',
      1 => 'К каким последствиям могут привести новые санкции США против России',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    ...
    array (
      0 => 'title_image',
      1 => 'assets/app/dest/images/page.png',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
    ...
    array (
      0 => 'sub_title',
      1 => 'К каким последствиям могут привести новые санкции',
      2 => 'default',
      3 => NULL,
      4 => 'text',
    ),
    'page_expert_message' => 
    array (
      0 => 'page_expert_message',
      1 => 'Наши Эксперты разработают и внедрят в Вашей организации проверенный опытом, научно-обоснованный комплаенс, с учетом актуальной правоприменительной практики контрольно-надзорных и судебных органов. 
Опыт и знания наших Экспертов – в Вашем распоряжении.',
      2 => 'default',
      3 => NULL,
      4 => 'textarea',
    ),
...
<html lang="en">
<head>
    <title>iCompliance - К каким последствиям могут привести новые санкции США против России</title>
...
<body>
    ...
    <div class="modal fade" id="feedback" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalLabel">Обратная связь</h5>
      ...
      <div class="modal-body">
        <form>
          <div class="form-group">
            <label for="your_name" class="col-form-label">Как мы можем к вам обращаться?</label>
            <input type="text" class="form-control" id="your_name" placeholder="ФИО">
          </div>
          <div class="form-group">
            <label for="your_phone" class="col-form-label">Телефон</label>
            <input type="text" class="form-control" id="your_phone" placeholder="Введите номер телефона">
          </div>
          <div class="form-group">
            <label for="your_email" class="col-form-label">E-mail</label>
            <input type="text" class="form-control" id="your_email" placeholder="Введите адрес электронной почты">
          </div>
         <div class="form-group">
            <label for="your_theme">Интересующая тематика</label>
            <select class="form-control" id="your_theme">
              <option disabled selected>Выберите интересуюшую вас тему</option>
              <option>Комплеанс</option>
              <option>2</option>
              <option>3</option>
            </select>
          </div>
          <div class="form-group">
            <label for="your_message" class="col-form-label">Ващ вопрос</label>
            <textarea class="form-control" id="your_message" rows="3" placeholder="Напишите свой вопрос"></textarea>
          </div>
        </form>
      </div>
      <div class="modal-footer">
        <button type="button" class="send_button">Отправить сообщение</button>
      </div>
    </div>
  </div>
</div>
...
[[!Wayfinder? 
    ...
    <div class="container-fluid flex1">
        <div class="container">
        	<div class="content d-flex flex-column col-xl-7 col-lg-8 col-md-8 page">
        		<div class="image">
        		    <img src="assets/app/dest/images/page.png" alt="К каким последствиям могут привести новые санкции США против России" title="К каким последствиям могут привести новые санкции США против России" />
        		</div>
        		<h1>К каким последствиям могут привести новые санкции США против России</h1>
        		<div class="slogan">К каким последствиям могут привести новые санкции США против России</div>
        		<div class="text">
        			<p>США сегодня <a href="http://www.forexpf.ru/news/2018/04/06/bm33-rubl-ne-otreagiroval-na-sanktsii-ssha-protiv-olega-deripaski-i-drugikh-biznesmen.html">ужесточили санкции</a> против России, включив в список ряд высокопоставленных должностных лиц, глав крупнейших компаний, в том числе государственных, а также ряд корпораций, в частности, «Рособоронэкспорт». Некоторые последствия этого решения стали очевидны уже сегодня. Так, снижается курс рубля, хотя основная заслуга здесь принадлежит дешевеющей нефти и падению цен на акции в США: инвесторы опасаются замедления темпов мирового экономического роста из-за рисков разрастания торгового противодействия США и Китая.</p>
<p>Акции En+ на новостях о новых санкциях США усилили падение и обрушились на 22%, Русала — на 12%, согласно данным Московской биржи. Компании подконтрольны Олегу Дерипаске. «Базовый Элемент», объединяющий активы Олега Дерипаски, сожалеет о попадании в санкционный список США и изучает сложившуюся в связи с этим ситуацию, говорится в сообщении БазЭла.</p>
<p><img src="assets/app/dest/images/page2.png" alt="" width="652" height="436" /></p>
<p>Число российских юридических лиц, включенные в санкционные списки OFAC, после публикации обновления в пятницу перевалило за 400. До сих пор под санкциями - как в «черном списке», так и под секторальными ограничениями — находилось 388 юрлиц из РФ, следует из данных информационной системы «Интерфакса» X-Compliance. Теперь таких юрлиц 401. Также в пятницу в SDN List было добавлено 24 физлица - всего под санкциями теперь находится 179 граждан РФ.</p>
<p>[[$Quote_inPage]]</p>
...
<p> </p>
        			...
        			<div class="callus_button" data-toggle="modal" data-target="#feedback">
...
<script src="assets/app/dest/js/script.js"></script>
</html>
...
<body>
    <div id="app" class="d-flex flex-column flex-wrap">',
    '[[$feedback]]' => '<div class="modal fade" id="feedback" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalLabel">Обратная связь</h5>
...
[[!Wayfinder? 
    ...
    '[[$Header]]' => '<div class="modal fade" id="feedback" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalLabel">Обратная связь</h5>
...
[[!Wayfinder? 
    ...
    '[[$CallButton]]' => '<div class="callus_button" data-toggle="modal" data-target="#feedback">
	<img src="assets/app/dest/images/button_call.svg" alt="" />
	<span>Связаться с нами</span>
</div>',
	...
	<div class="container col-xs-12">
      ...
      array (
        ...
        array (
          ...
          'category' => 13,
          'cache_type' => 0,
          'snippet' => '<div class="modal fade" id="feedback" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalLabel">Обратная связь</h5>
      ...
      <div class="modal-footer">
        <button type="button" class="send_button">Отправить сообщение</button>
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<div class="modal fade" id="feedback" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="ModalLabel">Обратная связь</h5>
    ...
    &lastClass =`` 
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '<div class="callus_button" data-toggle="modal" data-target="#feedback">
	<img src="assets/app/dest/images/button_call.svg" alt="" />
	<span>Связаться с нами</span>
</div>',
          'locked' => false,
          ...
          'static' => false,
          'static_file' => '',
          'content' => '<div class="callus_button" data-toggle="modal" data-target="#feedback">
	<img src="assets/app/dest/images/button_call.svg" alt="" />
	<span>Связаться с нами</span>
</div>',
        ),
